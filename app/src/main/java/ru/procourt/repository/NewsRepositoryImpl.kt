...
class NewsRepositoryImpl: NewsRepository {
    ...
    private var news = listOf(
        ...
        News(
            ...
            shareVkCount = 100000000
        ),
    ).reversed()

    private val data = MutableLiveData(news)

    override fun getAll(): LiveData<List<News>> = data

    override fun shareVkById(id: Long) {

    }

    override fun shareFbById(id: Long) {

    }

    override fun shareOutById(id: Long) {
