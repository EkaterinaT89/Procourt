...
class GamesAnotherPlayerFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentGamesAnotherPlayerBinding.inflate(
            inflater,
            container,
            false
        )
